#!/usr/bin/env python3
"""
Generate audio files for Unit 02 (People) using OpenAI TTS API
"""
...
def main():
    """Generate all audio files from audio_texts_unit02.json"""

    # Load texts from JSON
    with open('audio_texts_unit02.json', 'r', encoding='utf-8') as f:
        texts = json.load(f)

    print("=" * 60)
    print("🎙️  GENERATING AUDIO FILES FOR UNIT 02: PEOPLE")
    print("=" * 60)
    print()
    ...
    categories = [
        ('housewife_story', 'Housewife Story'),
        ('personality', 'Personality Adjectives'),
        ('personality_def', 'Personality Definitions'),
        ('time', 'Time Expressions'),
        ('frida', 'Frida Kahlo Biography'),
        ('past_cont', 'Past Continuous Examples'),
        ('opposites', 'Opposite Adjectives'),
        ('describe', 'Describing People Questions')
    ]
    ...
    print()
    print("=" * 60)
    print(f"✅ COMPLETE! Generated {total_files} audio files for Unit 02")
